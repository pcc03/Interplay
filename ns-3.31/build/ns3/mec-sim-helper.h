...
public:
  ...
  Ptr<MecHostContainer> InstallTwoMecHostsOneCell(Ptr<MecEntityContainer> bs, Ptr<Node> sys);
...
private:
  Ptr<MecHostContainer> InstallSingleMecHost(Ptr<MecEntityContainer> bs, Ptr<MultiaccessEdgeOrchestrator> meo, Ptr<MecEntityContainer> bsContainer);
  Ptr<MecHostContainer> InstallTwoMecHosts(Ptr<MecEntityContainer> bs, Ptr<MultiaccessEdgeOrchestrator> meo, Ptr<MecEntityContainer> bsContainer);
