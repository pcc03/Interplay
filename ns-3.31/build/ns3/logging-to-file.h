...
public:
  ...
  void HostScore(uint64_t hostId, double ss);
  void TaskDelay(uint64_t imsi, std::string ContextId, uint64_t appDiD, uint64_t hostId, double e2e, double processing,double task_size);
